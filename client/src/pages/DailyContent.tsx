...
export default function DailyContent() {
  ...
  const [contentData, setContentData] = useState<GeneratedContentData | null>(
    null
  );
      ...
      <div className="container space-y-8 py-8">
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground">
            Daily content is generated by level so you always have a small,
            focused set of material to review.
          </p>
        </div>
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <p className="text-sm italic">
                    Example: {contentData.grammar.example}
                  </p>
                </CardContent>
              </Card>
            ) : null}
